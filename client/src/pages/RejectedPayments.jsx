// client/src/pages/Admin/RejectedPayments.jsx
...
const RejectedPayments = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">❌ Rejected Payments</h2>
        ...
        <tbody>
          {payments.map((p) => (
            <tr key={p._id} className="text-center">
              ...
              <td className="border p-2 text-red-600 font-bold">{p.status}</td>
            </tr>
          ))}
        </tbody>
      </table>
